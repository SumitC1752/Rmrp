...
export default function QualityAssuranceCTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 py-20 sm:py-24 lg:py-28">
      ...
      >
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
          Partner With A Quality-Focused Global Supplier
        </h2>
        <p className="mt-5 text-lg text-gray-300/80 leading-relaxed max-w-xl mx-auto">
          Experience the difference that rigorous quality standards make. Contact us today to discuss your product requirements and let us show you what true quality partnership means.
        </p>
