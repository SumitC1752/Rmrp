...
export default function ProductQualityPackaging({ product }: { product: ProductData }) {
  return (
    <section className="bg-white py-20 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <ListCard badge="Quality Assurance" heading="Rigorous Quality Standards" items={product.qualityItems} />
          <ListCard badge="Packaging & Logistics" heading="Export-Ready Packaging" items={product.packagingItems} />
        </div>
      </div>
    </section>
  );
