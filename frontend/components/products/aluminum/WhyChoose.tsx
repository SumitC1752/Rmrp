...
const cardReveal = { hidden: { opacity: 0, y: 20 }, visible: (i: number) => ({ opacity: 1, y: 0, transition: { delay: 0.25 + i * 0.1, duration: 0.5, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] } }) };
...
export default function WhyChoose() {
  const { badge, heading, items } = pageContent.whyChoose;
  return (
