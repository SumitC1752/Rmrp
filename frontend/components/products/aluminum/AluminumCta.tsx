...
export default function AluminumCta() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 py-16 sm:py-20 lg:py-28">
      ...
      >
        <h2 className="text-[clamp(1.5rem,5.5vw,2.25rem)] sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
          Looking for Reliable Aluminum Ingot Suppliers?
        </h2>
        <p className="mt-5 text-[15px] sm:text-lg text-gray-300/80 leading-relaxed max-w-xl mx-auto">
          Get in touch with our trade desk for competitive pricing, detailed specifications, and tailored supply solutions. Response within 24 hours.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/request-quote" className="group inline-flex items-center gap-2 px-8 py-4 text-sm font-semibold tracking-wide uppercase rounded-lg bg-gold-500 text-navy-900 hover:bg-gold-400 transition-all duration-200 shadow-gold-sm hover:shadow-gold-lg w-full sm:w-auto">
            Request Quote
