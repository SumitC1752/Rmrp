...
export default function AluminumHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-navy-900 via-navy-800 to-navy-900 py-12 sm:py-16 lg:py-28">
      ...
      <m.div initial="hidden" animate="visible" transition={{ staggerChildren: 0.15 }} className="relative mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <m.h1 variants={fadeUp} className="text-[clamp(1.75rem,6vw,2.5rem)] sm:text-5xl lg:text-6xl font-bold text-white leading-tight max-w-3xl">{heading}</m.h1>
        <m.p variants={fadeUp} className="mt-5 text-[15px] sm:text-lg lg:text-xl text-gray-300/80 leading-relaxed max-w-2xl">{subheading}</m.p>
      </m.div>
    </section>
  );
}
